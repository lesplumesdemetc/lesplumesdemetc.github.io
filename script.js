document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    fr: {
      ...
      "story.caption": "Notre logo — Pékin, Soie et Faverolles FR.",
      "races.eyebrow": "Nos races",
      "races.heading": "Pékin, Faverolles & Soie",
      "races.intro": "Trois races attachantes, décoratives et très appréciées dans une basse-cour familiale.",
      ...
      "races.soie.label": "Race d’ornement",
      "races.soie.title": "Soie",
      "races.soie.text": "La poule Soie séduit par son plumage très doux, sa huppe caractéristique et son tempérament calme. Très familière et bonne couveuse, elle s’intègre parfaitement dans une basse-cour familiale et prend volontiers soin de ses poussins.",
      ...
      "eggs.racesValue": "Pékin, Faverolles ou Soie",
      ...
      "eggs.caption4": "Poule Soie avec ses poussins",
      ...
      "gallery.caption2": "Poussin Pékin gris",
      "gallery.caption3": "Portrait Faverolles",
      "gallery.caption4": "Coq Pékin avec ses deux poules",
      "gallery.caption5": "Poussin Soie",
      "gallery.caption6": "Poussin Faverolles",
      ...
      "meta.description": "Petit élevage familial à Champigny-sur-Marne : œufs fécondés, poules Pékin, Faverolles et Soie, poussins et renseignements par mail.",
    ...
    pt: {
      ...
      "story.caption": "O nosso logótipo — Pékin, Soie e Faverolles FR.",
      "races.eyebrow": "As nossas raças",
      "races.heading": "Pékin, Faverolles & Seda",
      "races.intro": "Três raças decorativas, cativantes e muito apreciadas numa capoeira familiar.",
      ...
      "races.soie.label": "Raça ornamental",
      "races.soie.title": "Seda",
      "races.soie.text": "A galinha de Seda distingue-se pela plumagem muito macia, pela poupa característica e pelo temperamento calmo. Muito dócil e excelente chocadeira, adapta-se perfeitamente a uma capoeira familiar e cuida com dedicação dos seus pintainhos.",
      ...
      "eggs.caption4": "Galinha de Seda com os seus pintainhos",
      ...
      "gallery.caption2": "Pintainho Pékin cinzento",
      "gallery.caption3": "Retrato Faverolles",
      "gallery.caption4": "Galo Pékin com as suas duas galinhas",
      "gallery.caption5": "Pintainho de Seda",
      "gallery.caption6": "Pintainho Faverolles",
      ...
      "meta.description": "Criação familiar modesta em Champigny-sur-Marne: ovos galados, galinhas Pékin, Faverolles e Seda, pintainhos e informações por e-mail.",
